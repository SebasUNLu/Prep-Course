...
function esEntero(numero) {
  ...
  if (numero === numFloor) return true;
  return false;
}
...
function fizzBuzz(numero) {
  ...
  let text = "";
  if (numero % 3 == 0) text += "fizz";
  if (numero % 5 == 0) text += "buzz";
  if (text === "") return numero;
  return text;
}
...
function tieneTresDigitos(numero) {
  ...
  //Escribe tu código aquí
  if (Math.abs(numero) > 99 && Math.abs(numero) < 1000) return true;
  return false;
}
